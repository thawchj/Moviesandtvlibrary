<template>
    <div class="body-tvshows">
        ...
        <div class="container-fluid px-5">
            <div class="row">
                <div v-for="m in tvshowsArr" :key="m.id" class="col-6 col-sm-4 col-md-3 col-lg-2 ">
...
export default {
  components: { Cardlib, Footerlib, Headerlib },
    async asyncData({$axios}){
      const res = await $axios.$get(`https://api.themoviedb.org/3/discover/tv?api_key=${process.env.API_KEY}&query=a&sort_by=popularity.desc&vote_count.gte=200&page=1`)
      return{
